    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-lg border border-slate-200">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-medium text-slate-600">Form Completion</span>
      ...
      <Tabs defaultValue="basic" className="w-full">
          ...
          <Card className="bg-white border-slate-200">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <Label htmlFor="name" className="mb-3 block text-slate-800">College Name *</Label>
                  <Input
                    id="name"
                    value={data.name || ''}
                    onChange={(e) => {
                ...
                <div>
                  <Label htmlFor="slug" className="mb-3 block text-slate-800">Slug *</Label>
                  <Input
                    id="slug"
                    value={data.slug || ''}
              ...
              <div>
                <Label htmlFor="country" className="mb-3 block text-slate-800">Country *</Label>
                <Select value={data.country_ref || ''} onValueChange={(value) => onChange('country_ref', value)}>
                  ...
                  <SelectContent className="bg-white border-slate-200">
                    {countries.map((country, index) => (
                      <SelectItem key={country._id || `country-${index}`} value={country.slug} className="text-slate-900 hover:bg-slate-100">
              ...
              {data.country_ref?.toLowerCase() === 'india' && (
                <div>
                  <Label htmlFor="city" className="mb-3 block text-slate-800">City *</Label>
                  {citiesLoading ? (
                    ...
                    <Select value={data.city || ''} onValueChange={(value) => onChange('city', value)}>
                      ...
                      <SelectContent className="bg-white border-slate-200 max-h-96" position="popper">
                        {cities
                          .filter(city => {
                          ...
                          .map((city) => (
                            <SelectItem key={city._id} value={city.slug} className="text-slate-900 hover:bg-slate-100">
                              {city.name}
                            </SelectItem>
                          ))}
                      </SelectContent>
              ...
              <div>
                <Label htmlFor="banner_url" className="mb-3 block text-slate-800">Banner URL</Label>
                <Input
                  id="banner_url"
              ...
              <div>
                <Label htmlFor="establishment_year" className="mb-3 block text-slate-800">Establishment Year</Label>
                <Input
              ...
              <div>
                <Label className="mb-3 block text-slate-800">Required Exams *</Label>
                ...
                <div className="flex flex-wrap gap-2">
                  {(data.exams || []).map((exam, index) => (
                    <div className='flex items-center bg-white rounded-lg px-3 py-1 gap-3 border border-slate-200' key={index}>
                      ...
                      <X className="h-3 w-3 cursor-pointer text-slate-500 hover:text-slate-900" onClick={(e) => { e.stopPropagation(); removeTag(index, data.exams || [], 'exams'); }} />
                    </div>
                  ))}
                </div>
              ...
              <div>
                <Label className="mb-3 block text-slate-800">College Categories *</Label>
                {categoriesLoading ? (
                  <div className="flex items-center justify-center p-4">
                    <div className="w-6 h-6 border-2 border-blue-600 border-t-transparent rounded-full animate-spin" />
                  ...
                  <div className="space-y-2">
                    {categories.map((category) => (
                      <div key={category.slug} className="flex items-start space-x-3 p-3 border border-slate-200 rounded-lg hover:bg-white">
                        <Checkbox
                          id={category.slug}
                        ...
                        />
                        <Label htmlFor={category.slug} className="text-slate-800">
        ...
        <TabsContent value="overview" className="space-y-4">
          <Card className="bg-white border-slate-200">
            ...
            <CardContent className="space-y-6">
              <div>
                <Label htmlFor="overview_title" className="mb-3 block text-slate-800">Overview Title</Label>
                <Input
                  id="overview_title"
              ...
              <div>
                <Label htmlFor="overview_description" className="mb-3 block text-slate-800">Overview Description *</Label>
                <Textarea
        ...
        <TabsContent value="highlights" className="space-y-4">
          <Card className="bg-white border-slate-200">
            ...
            <CardContent className="space-y-6">
              <div>
                <Label htmlFor="key_highlights_title" className="mb-3 block text-slate-800">Key Highlights Title</Label>
                <Input
              ...
              <div>
                <Label htmlFor="key_highlights_description" className="mb-3 block text-slate-800">Key Highlights Description</Label>
                <Textarea
              ...
              <div>
                <Label className="mb-3 block text-slate-800">Key Features</Label>
                <div className="flex gap-2 mb-3">
                  <Input
                    value={newFeature}
                ...
                <div className="flex flex-wrap gap-2">
                  {(data.key_highlights_features || []).map((feature, index) => (
                    <div className='flex items-center bg-white rounded-lg px-3 py-1 gap-3 border border-slate-200' key={index}>
                      ...
                      <X className="h-3 w-3 cursor-pointer text-slate-500 hover:text-slate-900" onClick={(e) => { e.stopPropagation(); removeTag(index, data.key_highlights_features || [], 'key_highlights_features'); }} />
                    </div>
                  ))}
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div>
                <Label htmlFor="why_choose_us_title" className="mb-3 block text-slate-800">Why Choose Us Title</Label>
                <Input
              ...
              <div>
                <Label htmlFor="why_choose_us_description" className="mb-3 block text-slate-800">Why Choose Us Description</Label>
                <Textarea
              ...
              <div>
                <Label className="mb-3 block text-slate-800">Features (Title - Description)</Label>
        ...
        <TabsContent value="admission" className="space-y-4">
          ...
          <Card className="bg-white border-slate-200">
            ...
            <CardContent className="space-y-4">
              <div>
                <Label htmlFor="ranking_title" className="mb-3 block text-slate-800">Ranking Title</Label>
                <Input
                  id="ranking_title"
              ...
              <div>
                <Label htmlFor="ranking_description" className="mb-3 block text-slate-800">Ranking Description</Label>
                <Textarea
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="country_ranking" className="mb-3 block text-slate-800">Country Ranking</Label>
                  <Input
                    id="country_ranking"
                ...
                <div>
                  <Label htmlFor="world_ranking" className="mb-3 block text-slate-800">World Ranking</Label>
                  <Input
                    id="world_ranking"
              ...
              <div>
                <Label className="mb-3 block text-slate-800">Accreditation</Label>
                ...
                <div className="flex flex-wrap gap-2">
                  {(data.accreditation || []).map((acc, index) => (
                    <div className='flex items-center bg-white rounded-lg px-3 py-1 gap-3 border border-slate-200' key={index}>
                      ...
                      <X className="h-3 w-3 cursor-pointer text-slate-500 hover:text-slate-900" onClick={(e) => { e.stopPropagation(); removeTag(index, data.accreditation || [], 'accreditation'); }} />
                    </div>
                  ))}
                </div>
              </div>
          ...
          <Card className="bg-white border-slate-200">
            ...
            <CardContent className="space-y-6">
              <div>
                <Label htmlFor="admission_process_title" className="mb-3 block text-slate-800">Admission Process Title</Label>
                <Input
              ...
              <div>
                <Label htmlFor="admission_process_description" className="mb-3 block text-slate-800">Admission Process Description</Label>
                <Textarea
              ...
              <div>
                <Label className="mb-3 block text-slate-800">Admission Steps</Label>
                <div className="flex gap-2 mb-3">
                  <Input
                ...
                <div className="flex flex-wrap gap-2">
                  {(data.admission_process_steps || []).map((step, index) => (
                    <div className='flex items-center bg-white rounded-lg px-3 py-1 gap-3 border border-slate-200' key={index}>
                      ...
                      <X className="h-3 w-3 cursor-pointer text-slate-500 hover:text-slate-900" onClick={(e) => { e.stopPropagation(); removeTag(index, data.admission_process_steps || [], 'admission_process_steps'); }} />
                    </div>
                  ))}
                </div>
              </div>
          ...
          <Card className="bg-white border-slate-200">
            ...
            <CardContent className="space-y-4">
              <div>
                <Label htmlFor="documents_required_title" className="mb-3 block text-slate-800">Documents Required Title</Label>
                <Input
              ...
              <div>
                <Label htmlFor="documents_required_description" className="mb-3 block text-slate-800">Documents Required Description</Label>
                <Textarea
              ...
              <div>
                <Label className="mb-3 block text-slate-800">Required Documents</Label>
                <div className="flex gap-2 mb-2">
                  <Input
                    value={newDocument}
                ...
                <div className="flex flex-wrap gap-2">
                  {(data.documents_required_documents || []).map((doc, index) => (
                    <div className='flex items-center bg-white rounded-lg px-3 py-1 gap-3 border border-slate-200' key={index}>
                      ...
                      <X className="h-3 w-3 cursor-pointer text-slate-500 hover:text-slate-900" onClick={(e) => { e.stopPropagation(); removeTag(index, data.documents_required_documents || [], 'documents_required_documents'); }} />
                    </div>
                  ))}
                </div>
              </div>
          ...
          <Card className="bg-white border-slate-200">
            ...
            <CardContent className="space-y-4">
              <div>
                <Label htmlFor="fees_structure_title" className="mb-3 block text-slate-800">Fees Structure Title</Label>
                <Input
              ...
              <div>
                <Label htmlFor="fees_structure_description" className="mb-3 block text-slate-800">Fees Structure Description</Label>
                <Textarea
              ...
              <div>
                <Label className="mb-3 block text-slate-800">Courses</Label>
                  ...
                  {(data.fees_structure_courses || []).map((course, index) => (
                    <div key={index} className="flex items-center justify-between p-3 border border-slate-200 rounded-lg">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 flex-1">
                        ...
                        <div className="text-sm font-medium text-slate-900">{course.annual_tuition_fee}</div>
                      </div>
        ...
        <TabsContent value="campus" className="space-y-4">
          <Card className="bg-white border-slate-200">
            ...
            <CardContent className="space-y-6">
              <div>
                <Label htmlFor="campus_highlights_title" className="mb-3 block text-slate-800">Campus Highlights Title</Label>
                <Input
              ...
              <div>
                <Label htmlFor="campus_highlights_description" className="mb-3 block text-slate-800">Campus Highlights Description</Label>
                <Textarea
              ...
              <div>
                <Label className="mb-3 block text-slate-800">Campus Highlights</Label>
                <div className="flex gap-2 mb-3">
                  <Input
                ...
                <div className="flex flex-wrap gap-2">
                  {(data.campus_highlights_highlights || []).map((highlight, index) => (
                    <div className='flex items-center bg-white rounded-lg px-3 py-1 gap-3 border border-slate-200' key={index}>
                      ...
                      <X className="h-3 w-3 cursor-pointer text-slate-500 hover:text-slate-900" onClick={(e) => { e.stopPropagation(); removeTag(index, data.campus_highlights_highlights || [], 'campus_highlights_highlights'); }} />
                    </div>
                  ))}
                </div>
              </div>
