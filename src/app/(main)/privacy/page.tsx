    ...
    <div className="min-h-screen py-[32px] bg-white">
      <div className="max-w-4xl mx-auto px-6 py-[32px]">
        ...
        <div className="space-y-8">
          <div className="border-l-4 border-[#0066F5] pl-6">
            <h2 className="text-xl font-semibold text-[#1E293B] mb-3 flex items-center gap-2">
              <FileText className="w-5 h-5 text-[#0066F5]" />
              1. Introduction
            </h2>
          ...
          <div className="border-l-4 border-[#0066F5] pl-6">
            <h2 className="text-xl font-semibold text-[#1E293B] mb-3 flex items-center gap-2">
              <Eye className="w-5 h-5 text-[#0066F5]" />
              2. Information We Collect
            </h2>
            <ul className="space-y-2 text-[#64748B]">
              <li className="flex items-start gap-2">
                <span className="text-[#0066F5] mt-1">•</span>
          ...
          <div className="border-l-4 border-[#0066F5] pl-6">
            <h2 className="text-xl font-semibold text-[#1E293B] mb-3 flex items-center gap-2">
              <svg className="w-5 h-5 text-[#0066F5]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div className="border-l-4 border-[#0066F5] pl-6">
            <h2 className="text-xl font-semibold text-[#1E293B] mb-3 flex items-center gap-2">
              <Lock className="w-5 h-5 text-[#0066F5]" />
              4. Data Security
            </h2>
            <p className="text-[#64748B] leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href={`mailto:${contact.email.general}`} className="text-[#1E293B] font-medium hover:text-[#0066F5]">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href={`tel:${contact.phone.raw}`} className="text-[#1E293B] font-medium hover:text-[#0066F5]">
