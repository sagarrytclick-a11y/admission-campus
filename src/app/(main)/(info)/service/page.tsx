      ...
      <section className="w-full py-20 bg-gradient-to-br from-blue-900/90 via-blue-800/80 to-blue-900/90">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            ...
            <span className="block text-[#FFD700]">Admission Solution</span>
          </h1>
        ...
        <section className="py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-8 hover:border-[#1E6BFF] transition-colors">
                <div className="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center mb-6">
                  <GraduationCap size={24} className="text-[#1E6BFF]" />
                </div>
                ...
                <a href="#" className="text-[#1E6BFF] font-medium flex items-center gap-1">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-8 hover:border-[#1E6BFF] transition-colors">
                <div className="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center mb-6">
                  <FileText size={24} className="text-[#1E6BFF]" />
                </div>
                <h3 className="text-xl font-semibold text-slate-900 mb-3">
                  Entrance Exam Prep
                </h3>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-8 hover:border-[#1E6BFF] transition-colors">
                <div className="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center mb-6">
                  <Home size={24} className="text-[#1E6BFF]" />
                </div>
                <h3 className="text-xl font-semibold text-slate-900 mb-3">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-8 hover:border-[#1E6BFF] transition-colors">
                <div className="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center mb-6">
                  <DollarSign size={24} className="text-[#1E6BFF]" />
                </div>
                <h3 className="text-xl font-semibold text-slate-900 mb-3">
                  Scholarships & Aid
                </h3>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-8 hover:border-[#1E6BFF] transition-colors">
                <div className="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center mb-6">
                  <BookOpen size={24} className="text-[#1E6BFF]" />
                </div>
                <h3 className="text-xl font-semibold text-slate-900 mb-3">
                  Test Preparation
                </h3>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-8 hover:border-[#1E6BFF] transition-colors">
                <div className="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center mb-6">
                  <TrendingUp size={24} className="text-[#1E6BFF]" />
                </div>
                <h3 className="text-xl font-semibold text-slate-900 mb-3">
                  Career Counseling
                </h3>
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
              <div className="text-center">
                <div className="text-3xl font-bold text-[#1E6BFF]">10,000</div>
                <div className="text-sm text-slate-500 mt-1">Students Placed</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[#1E6BFF]">500</div>
                <div className="text-sm text-slate-500 mt-1">College Partners</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[#1E6BFF]">25</div>
                <div className="text-sm text-slate-500 mt-1">States Covered</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[#1E6BFF]">₹50Cr</div>
                <div className="text-sm text-slate-500 mt-1">Scholarships</div>
              </div>
            </div>

            <div className="text-center">
              <Link href="/contact" className="inline-flex items-center gap-2 bg-[#1E6BFF] text-white px-8 py-3 rounded-full font-medium hover:bg-blue-700 transition-colors">
                Start Your Journey
